...
var getTime = function (input) {
    ...
    var timeRangeMatch = input.match(/(\d+)\s+to\s+(\d+)/);
    if (timeRangeMatch) {
        var _ = timeRangeMatch[0], start = timeRangeMatch[1], end = timeRangeMatch[2];
        ...
        if (startNum > endNum && startNum > 100) {
            return "".concat(Math.floor(startNum / 10), " to ").concat(endNum);
        }
        return "".concat(startNum, " to ").concat(endNum);
    }
...
function findDialogAndReadData(img) {
    return __awaiter(this, void 0, void 0, function () {
        var pixels, diagReader, dialog, pngImage, text, world, location, time, size;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logs.innerHTML = '';
